...
⚙️ Built with React, TypeScript, Tailwind, Framer Motion, and Recharts.
...
- ☀️ **Day ledger** (light): aged paper, iron-gall ink, the ruled margin line
...
- 🎛️ **Needle gauges**: 240° graduated dials with counterweighted needles
- ⏳ **Split-flap countdown**: rolling wheels with a flap hinge, to the next due date
- ⏱️ **The escapement**: a 60-graduation seconds dial; interest never sleeps
- 🏷️ **Rubber stamps**: months print SETTLED or CURRENT as they pass
